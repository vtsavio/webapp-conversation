 ...
 */
  ...
  return (
    <div className={cn('group relative pt-2 pb-8 -ml-4 pl-4 -mr-4 pr-4 dark:bg-[#222222] transition-colors duration-200', s.answerWrap)}>
      <div className='flex'>
        <div className='w-[24px] h-[24px] rounded-full shrink-0'>
          <div className={`w-full h-full ${s.answerIcon}`}>
            {isResponding && (
            ...
            <div className='flex items-start'>
              ...
              <div className={`${s.answerWrap}`}>
                <div className={`${s.answer} relative text-sm text-gray-900 dark:text-gray-100`}>
                  <div className={`ml-2 py-3 px-4 bg-gray-100 dark:bg-[#333333] rounded-tr-2xl rounded-b-2xl ${workflowProcess && 'min-w-[480px]'}`}>
                    {workflowProcess && (
